...
from keras_nlp.models.t5.t5_seq_2_seq_lm_preprocessor import (
...
@keras_nlp_export("keras_nlp.models.T5Seq2SeqLM")
class T5Seq2SeqLM(GenerativeTask):
    ...
    Args:
        backbone: A `keras_nlp.models.T5Backbone` instance.
        preprocessor: A `keras_nlp.models.T5Seq2SeqLMPreprocessor` or `None`.
    ...
    ```python
    bart_lm = keras_nlp.models.T5Seq2SeqLM.from_preset("bart_base_en")
